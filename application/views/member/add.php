                ...
                <form class="form-horizontal" action="<?= base_url('member/add') ?>" method="POST">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo set_value('customer_firstname'); ?>" class="form-control"  name="customer_firstname" data-validation="required" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">นามสกุล</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo set_value('customer_lastname'); ?>" class="form-control" id="" name="customer_lastname" data-validation="required"  >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">ที่อยู่</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="customer_address" data-validation="required"  rows="3"><?php echo set_value('customer_address'); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">จังหวัด</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" data-validation="required"  id="inputPassword3" name="province" value="<?php echo set_value('province'); ?>" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">รหัสไปษณีย์</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" data-validation="required"  id="inputPassword3" name="zipcode" value="<?php echo set_value('zipcode'); ?>" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">เบอร์มือถือ</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" data-validation="required"  id="inputPassword3"  name="customer_tel" value="<?php echo set_value('customer_tel'); ?>">
                            </div>
                        </div>
