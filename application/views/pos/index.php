...
<section class="content">
    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input type="text" name="cash_receive" id="cash_receive"  class="form-control" style="font-size: 36px;font-weight: lighter; height: 55px;">
                            ...
                            <div class="pull-left">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" id="copy_receipt" name="Copy Receipt" class="hidden" checked=""> Copy Receipt
                                            </label>
                                        </div>
                                    </div>
                                </div>
        ...
        <?php if ($pos == 'buy_back_home') { ?>
            <div class="" id="main-backhome-control">
        ...
        <?php } ?>
        <?php if ($pos == 'barista') { ?>
            <div class="col-md-6 col-md-push-6" id="detail-control">
                <div class="col-md-12">
                    <form action="<?= base_url() ?>pos/buy_back_home" method="POST">
                        <input type="hidden" id="active_order_id_selected_detail" name="active_order_id_selected_detail" value="">
                        <div class="box box-widget">
            ...
            <div class="col-md-6 col-md-pull-6" id="main-backhome-control">
                                                ...
                                                if (open_detail === '') {
                                                    ...
                                                    if ($("#last_update").val() === data2[0].last_update && $("#num_rows").val() === data2[0].num_rows) {
                                                        ...
                                                        $.each(data2, function (i, val) {
                                                            ...
                                                            html += "<td style='font-size: 16px;'>" + val.product + "  (" + menu_type + ")<span class='pull-right'><button type='button' class='btn btn-xs btn-default'  onclick='edit_qty(this)' ><i class='fa fa-edit'></i> จำนวน</button>&nbsp;&nbsp;<label class='control-label " + class_text_color + "' for='inputWarning' style='font-weight: lighter;'> " + text_status + "</label></span>"+label+"  </td>";
